...
if play_game:
    ...
    #caption and dp
    pygame.display.set_caption("SUIII RUNNER")
    icon = pygame.image.load('footballer.png')
    ...
    jump = False
    score = 0
    player = pygame.image.load('ronaldo1.png')
    player2 = pygame.image.load('ronaldo2.png')
